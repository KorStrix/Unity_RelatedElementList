...
public class CManagerReplay : CSingletonDynamicMonoBase<CManagerReplay>
{
    ...
    public CObserverSubject<EReplayState> p_Event_OnChange_ReplayState { get; private set; } = new CObserverSubject<EReplayState>();
    ...
    /// </summary>
    public CObserverSubject<Replay_Arg> p_Event_OnPlayingReplay { get; private set; } = new CObserverSubject<Replay_Arg>();
